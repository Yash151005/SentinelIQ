...
if not rbac_engine.check_page_permission(st.session_state.get("role"), "Anomaly_Engine"):
    st.error("❌ Access Denied: You do not have permission to view the Anomaly Engine.")
    st.stop()
