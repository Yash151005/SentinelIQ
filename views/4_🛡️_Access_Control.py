...
if not rbac_engine.check_page_permission(st.session_state.get("role"), "Access_Control"):
    st.error("❌ Access Denied: You do not have permission to view the Access Control page.")
    st.stop()
